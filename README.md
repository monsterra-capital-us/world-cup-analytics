...
All predictions, probabilities, odds and statistics are generated by an
automated model and third-party data feeds, are provided "as is" for
informational purposes only, and may contain errors. Nothing in this
project constitutes betting, investment or financial advice, and no
responsibility or liability is accepted for any loss arising from bets,
wagers or decisions made in reliance on this data.
